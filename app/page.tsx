    ...
    <section className="flex flex-col items-center text-white text-sm font-[Poppins] relative overflow-hidden">
      ...
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="#data-processing" className="hover:text-slate-300">
            Data Processing
          </Link>
          <Link href="#insights" className="hover:text-slate-300">
            Insights
          </Link>
          <Link href="#visualization" className="hover:text-slate-300">
            Visualization
          </Link>
        </div>
      ...
      >
        ...
        <Link href="#data-processing" onClick={() => setIsOpen(false)}>
          Data Processing
        </Link>
